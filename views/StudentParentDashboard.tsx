...
import { MOCK_SCHOOLS, MOCK_SESSIONS } from '../constants';
import ReportSheet from '../components/ReportSheet';
import { Eye, Download, GraduationCap, Calendar, History } from 'lucide-react';
...
const StudentParentDashboard: React.FC<StudentParentDashboardProps> = ({ user, defaultTab }) => {
  ...
  // Mock results
  // Added missing id, teacherId, and submissionTime properties to satisfy ResultEntry interface
    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">Academic summary and report history for the 2023/2024 Session.</p>
        </div>
        <div className="flex items-center gap-4 bg-white p-3 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <div>
            <div className="text-[10px] text-slate-400 font-black uppercase tracking-widest">Enrollment Status</div>
            <div className="text-sm font-bold text-slate-900">ACTIVE - Grade 10B</div>
          </div>
        </div>
      </div>
